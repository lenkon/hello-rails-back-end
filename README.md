...
**Hello Rails Back-End** 
is an API webservice built as backend using Ruby on Rails. This app exposes an API service that could be used by a React front end application.

## Hello React Front-End Repository
...
```
  $ git clone git@github.com:lenkon/hello-rails-back-end.git
